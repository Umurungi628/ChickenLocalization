...
model = YOLO(r'C:\Users\User\PycharmProjects\ChickenLocalization\ChickenLocalization-main\yolov10_detect_result\detect\train\weights\best.pt')  # Update this with correct path to your best.pt file
